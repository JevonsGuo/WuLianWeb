...
function ProductsContent() {
  ...
  return (
    <>
      ...
      {loading ? (
         <div className="px-4 sm:px-6 lg:px-8 py-4" style={{ minHeight: 'calc((100vh - 64px - 160px) * 1.5)' }}>
           <div className="h-full flex items-center justify-center">
             <div className="animate-pulse text-surface-400">加载中...</div>
           </div>
         </div>
       ) : (
        <div className="products-page-wrapper px-4 sm:px-6 lg:px-8 py-4 relative overflow-hidden" style={{ minHeight: 'calc((100vh - 64px - 160px) * 1.5)' }}>
